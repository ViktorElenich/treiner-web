...
**Онлайн-программы** (закрытый Telegram-канал, кнопки ведут на @ViktorElenich):
- СТАРТ — 2 000 ₽/мес
...
Все Telegram-ссылки ведут на https://t.me/ViktorElenich (включая кнопки "Выбрать" в тарифах, плавающую кнопку, footer). Телефон и email в footer. Телефон в JSON-LD schema.
...
| Фото About | `index.html` (секция about) | Фото тренера с клиентом (промпт в `assets/photo-prompts.md`) |
...
1. **Hero** — `assets/img/hero.jpg` (140KB) — готово
2. **About** — тренер работает с клиентом, корректирует технику — **ожидает добавления**
3. **OG** — кроп из Hero, 1200x630px, для превью ссылок — **ожидает добавления** (`assets/img/og.jpg`)
...
- Этап 1 (готов): /start, меню тарифов, консультация, информация о тренере
- Этап 2 (в работе): оплата через ЮKassa, автодоступ к закрытому Telegram-каналу

## Что можно добавить в будущем

- Фото About (тренер с клиентом) и OG-изображение (1200x630)
- Интеграция форм с backend (Telegram Bot API / webhook)
